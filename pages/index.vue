<template>
  <PageContainer>
    <div>
      ...
      <div v-else class="flex flex-wrap">
        ...
        <div class="flex-[1_1_50%] max-w-[50%] sm:flex-[1_1_33%] sm:max-w-[33%] md:flex-[1_1_25%] md:max-w-[25%] lg:flex-[1_1_20%] lg:max-w-[20%] flex items-center justify-start p-2 rounded">
          <div class="w-[160px] h-[100px] flex items-center justify-start bg-[#FFFFFF]">
            <NuxtLink to="/products">
              <button class="rounded-full sm:ml-2 p-2 pl-3 bg-custom-orange hover:bg-custom-dark-orange text-[#FFFFFF] text-sm uppercase">
                See more
    ...
    <div class="text-3xl mt-12 text-center sm:text-left">
      ...
      <div class="flex flex-col sm:flex-row items-center pl-6 pt-6 hover:text-custom-dark-blue">
        <Icon name="mdi:file-code-outline" size="48"/>
        <NuxtLink to="https://github.com/attilabiczo/charts" target="_blank" class="text-[20px]">
          https://github.com/attilabiczo/charts
        </NuxtLink>
      </div>
    </div>
  </PageContainer>
