<template>
  <PageContainer>
        ...
        <div class="flex-[1_1_50%] max-w-[50%] sm:flex-[1_1_33%] sm:max-w-[33%] md:flex-[1_1_25%] md:max-w-[25%] lg:flex-[1_1_20%] lg:max-w-[20%] flex items-center justify-start p-2 rounded">
          <div class="w-[160px] h-[100px] flex items-center justify-start bg-[#FFFFFF] dark:bg-custom-dark-background">
            <NuxtLink to="/products">
              <button class="rounded-full sm:ml-2 p-3 bg-custom-orange dark:border dark:border-custom-orange dark:bg-custom-dark-background hover:bg-custom-secondary-orange text-[#FFFFFF] dark:text-custom-orange text-sm uppercase">
                See more
              </button>
            </NuxtLink>
          </div>
    ...
    <div class="text-3xl mt-12 text-center sm:text-left">
      ...
      <div class="flex flex-col sm:flex-row items-center pl-6 pt-6 hover:text-custom-secondary-blue">
